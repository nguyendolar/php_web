                                    ...
                                    <div class="card-body">
                                        <form action="checklogin.php" method="POST">
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputEmail" type="text" placeholder="" name="name" required />
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                                <a href="login.php">Đăng nhập</button>
                                                <button class="btn btn-primary" type="submit" style="margin-left:250px" name="register">Đăng Ký</button>
                                            </div>
                                        </form>
                                    </div>
